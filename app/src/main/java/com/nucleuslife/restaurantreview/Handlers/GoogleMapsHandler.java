...
{
    private static final String TAG = GoogleMapsHandler.class.getSimpleName();
    ...
    public GoogleMapsHandler(Context context)
    {
    ...
    public void getMapSync(SupportMapFragment mapFragment)
    {
        mapFragment.getMapAsync(this);
